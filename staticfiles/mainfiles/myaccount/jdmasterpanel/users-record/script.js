  ...
  try {
    ...
    querySnapshot.forEach((documentSnapshot) => {
      ...
      try {
        ...
        // School
const schoolCell = document.createElement("td");
schoolCell.textContent = userProfile.education && userProfile.education[0]
...
// Degree
const degreeCell = document.createElement("td");
degreeCell.textContent = userProfile.education && userProfile.education[0]
  ? userProfile.education[0].degree || "N/A"
  : "N/A";
row.appendChild(degreeCell);

// Graduation Date
const graduationDateCell = document.createElement("td");
graduationDateCell.textContent = userProfile.education && userProfile.education[0]
  ? userProfile.education[0].graduation_date || "N/A"
  : "N/A";
row.appendChild(graduationDateCell);
        ...
        skillsCell.textContent = Array.isArray(userProfile.skills)
  ...
  : "N/A";
        ...
        editButton.addEventListener("click", () => {
          ...
          window.open("jobs-applied/?user=" + userEmail, "_blank");
        });
