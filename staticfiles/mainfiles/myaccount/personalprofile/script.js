...
function populateForm(userData) {
  ...
  document.getElementById("mob").innerText = userData.about?.phoneNo || "";
  document.getElementById("gender").innerText = userData.about?.gender || "";
  document.getElementById("edit-email").value = userData.about?.email || "xyz@gmail.com";
  document.getElementById("edit-phone").value = userData.about?.phoneNo || "1234567890";
  document.getElementById("edit-name").value = fullName || "John Doe";
  document.getElementById("edit-dob").value = userData.about?.dob || "2000-01-02";
  document.getElementById("edit-gender").value = userData.about?.gender || "Male / Female";
  ...
  //   console.log(userProfileRef);
    try {
      ...
      if(docSnap.exists){
        ...
        await updateDoc(userProfileRef, { about: aboutData });
      }
      else{
